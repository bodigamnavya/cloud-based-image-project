...
main = tkinter.Tk()
main.title("CLOUD-BASED IMAGE ANALYSIS FOR DETECTING FRUIT DISEASES AUTOMATICALLY")
...
font = ('times', 16, 'bold')
title = Label(main, text=' CLOUD-BASED IMAGE ANALYSIS FOR DETECTING FRUIT DISEASES AUTOMATICALLY')
